...
[Week 08](../week08_uncertainty/theory.md#3-two-kinds-of-uncertainty) established how to quantify uncertainty in static settings (bootstrap, Bayesian intervals, calibration). This week applies those ideas to **data ordered in time**, where consecutive observations are no longer independent.
...
**Prerequisites.** [Week 03](../../02_fundamentals/week03_linear_models/theory.md#3-linear-regression) (linear regression — AR models generalise it), [Week 06](../../02_fundamentals/week06_regularization/theory.md#7-time-series-cross-validation) (time-series cross-validation), [Week 07](../week07_likelihood/theory.md#4-maximum-likelihood-estimation-mle)–[08](../week08_uncertainty/theory.md#10-prediction-intervals) (likelihood, residual diagnostics, calibration).
...
> **Connection to [Week 08](../week08_uncertainty/theory.md#10-prediction-intervals).** This is the time-series version of uncertainty propagation. Multi-step forecasts compound epistemic uncertainty at each step, analogous to how Bayesian predictive variance is wider where data is sparse.
...
| Week                           | Connection                                                                                                            |
| ------------------------------ | --------------------------------------------------------------------------------------------------------------------- |
| **[Week 03](../../02_fundamentals/week03_linear_models/theory.md#3-linear-regression) (Linear Models)**    | AR(p) is a linear regression where the features are lagged values of $Y$                                              |
| **[Week 06](../../02_fundamentals/week06_regularization/theory.md#7-time-series-cross-validation) (Regularisation)**   | Walk-forward CV was introduced; Ridge applies to AR models to prevent overfitting with many lags                      |
| **[Week 07](../week07_likelihood/theory.md#4-maximum-likelihood-estimation-mle) (Likelihood)**       | ARIMA coefficients are estimated by MLE; AIC/BIC are likelihood-based model selection criteria                        |
| **[Week 08](../week08_uncertainty/theory.md#10-prediction-intervals) (Uncertainty)**      | Prediction intervals for multi-step forecasts; residual calibration; Bayesian time-series models                      |
| **[Week 10](../week10_surrogate_models/theory.md#6-kernel-functions) (Surrogate Models)** | Gaussian Processes use autocovariance kernels (e.g., Matérn, periodic) for temporal modelling                         |
| **[Week 11](../../04_neural_networks/week11_nn_from_scratch/theory.md#2-from-linear-models-to-neural-networks) (Neural Networks)**  | Recurrent architectures (RNNs, LSTMs) learn non-linear autoregressive dynamics                                        |
| **[Week 17](../../06_sequence_models/week17_attention/theory.md#31-the-query-key-value-framework) (Attention)**        | Attention replaces fixed-lag structure; the model learns which past timesteps matter                                  |
| **[Week 18](../../06_sequence_models/week18_transformers/theory.md#3-input-representation) (Transformers)**     | Positional encodings play the role of time indices; Transformer-based forecasting (e.g., Temporal Fusion Transformer) |
