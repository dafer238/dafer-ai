...
[Week 06](../../02_fundamentals/week06_regularization/theory.md#3-ridge-regression-l2-regularisation) introduced regularisation for linear models (Ridge, Lasso, cross-validation). This week is the deep-learning counterpart: the goal — controlling overfitting — is identical, but the tools change because deep networks have millions of parameters, stochastic training, and layer-specific dynamics.
...
**Prerequisites.** [Week 06](../../02_fundamentals/week06_regularization/theory.md#3-ridge-regression-l2-regularisation) (L1/L2 regularisation, cross-validation), [Week 12](../../04_neural_networks/week12_training_pathologies/theory.md#7-fix-2-batch-normalisation) (BatchNorm), [Week 13](../week13_pytorch_basics/theory.md#8-the-training-loop) (PyTorch training loop), [Week 15](../week15_cnn_representations/theory.md#8-building-a-cnn-in-pytorch) (CNN to regularise).
...
From [Week 06](../../02_fundamentals/week06_regularization/theory.md#21-biasvariance-recap):
...
- **In Transformers:** after attention and after the feedforward block ([Week 18](../../06_sequence_models/week18_transformers/theory.md#92-dropout-placement)).
...
From [Week 12](../../04_neural_networks/week12_training_pathologies/theory.md#7-fix-2-batch-normalisation), BatchNorm normalises activations using mini-batch statistics. This introduces **noise** because:
...
This connects to [Week 08](../../03_probability/week08_uncertainty/theory.md#3-two-kinds-of-uncertainty) (uncertainty): MC Dropout provides uncertainty estimates without training an ensemble.
...
3. **Improved calibration.** Probabilities better reflect true confidence ([Week 08](../../03_probability/week08_uncertainty/theory.md#9-calibration) connection).
...
| Week                                     | Connection                                                                                                      |
| ---------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| **[Week 06](../../02_fundamentals/week06_regularization/theory.md#3-ridge-regression-l2-regularisation) (Regularisation)**             | Ridge/Lasso for linear models; same $\lambda\|\theta\|^2$ penalty now applied to neural networks                |
| **[Week 08](../../03_probability/week08_uncertainty/theory.md#3-two-kinds-of-uncertainty) (Uncertainty)**                | MC Dropout for uncertainty; calibration improved by label smoothing                                             |
| **[Week 12](../../04_neural_networks/week12_training_pathologies/theory.md#7-fix-2-batch-normalisation) (Training Pathologies)**       | BatchNorm's regularising side effect; interaction with dropout                                                  |
| **[Week 14](../week14_training_at_scale/theory.md#4-learning-rate-schedules) (Training at Scale)**          | Weight decay interacts with LR schedule ($\eta\lambda$ effective strength); augmentation in DataLoader pipeline |
| **[Week 15](../week15_cnn_representations/theory.md#8-building-a-cnn-in-pytorch) (CNNs)**                       | The CNN built there is the model being regularised here; spatial dropout `Dropout2d`                            |
| **[Week 17](../../06_sequence_models/week17_attention/theory.md#31-the-query-key-value-framework)–[Week 18](../../06_sequence_models/week18_transformers/theory.md#92-dropout-placement) (Attention, Transformers)** | Dropout in attention layers and FFN; weight decay with AdamW is standard for Transformers                       |
| **[Week 19](../../07_transfer_learning/week19_finetuning/theory.md#3-adaptation-strategies) (Fine-Tuning)**                | Fine-tuning is a form of regularisation: pretrained weights constrain the solution space                        |
...
| ----------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- |
| Try Dropout2d (`nn.Dropout2d(0.25)`) after conv layers in [Week 15](../week15_cnn_representations/theory.md#8-building-a-cnn-in-pytorch)'s CNN                                           | Spatial dropout drops entire feature maps; different from per-neuron |
