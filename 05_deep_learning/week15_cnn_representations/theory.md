...
3. **Transfer learning preview** — extracting features from a pretrained model and reusing them, a pattern formalised in [Week 19](../../07_transfer_learning/week19_finetuning/theory.md#3-adaptation-strategies).

**Prerequisites.** [Week 11](../../04_neural_networks/week11_nn_from_scratch/theory.md#5-backpropagation) (backpropagation), [Week 12](../../04_neural_networks/week12_training_pathologies/theory.md#7-fix-2-batch-normalisation) (BatchNorm), [Week 13](../week13_pytorch_basics/theory.md#4-building-models-with-nnmodule) (PyTorch `nn.Module`, training loop), [Week 14](../week14_training_at_scale/theory.md#2-the-data-pipeline) (efficient DataLoader, checkpointing).
...
> Fine-tuning is covered in depth in [Week 19](../../07_transfer_learning/week19_finetuning/theory.md#3-adaptation-strategies).
...
| **ResNet**                | 2015 | Residual (skip) connections ([Week 12](../../04_neural_networks/week12_training_pathologies/theory.md#10-fix-5-residual-skip-connections))                     | 50–152   |
...
**The ResNet insight.** Skip connections ([Week 12](../../04_neural_networks/week12_training_pathologies/theory.md#10-fix-5-residual-skip-connections)) enable training 100+ layer networks by providing gradient shortcuts through the identity path.
...
| Week                               | Connection                                                                                   |
| ---------------------------------- | -------------------------------------------------------------------------------------------- |
| **[Week 00a](../../01_intro/week00_ai_landscape/theory.md#92-inductive-bias) (AI Landscape)**        | Inductive bias — CNNs encode locality and translation equivariance                           |
| **[Week 11](../../04_neural_networks/week11_nn_from_scratch/theory.md#5-backpropagation) (NN from Scratch)**      | Convolution is backpropagated the same way: chain rule through the conv operation            |
| **[Week 12](../../04_neural_networks/week12_training_pathologies/theory.md#10-fix-5-residual-skip-connections) (Training Pathologies)** | BatchNorm2d, residual connections, He init — all used in CNNs                                |
| **[Week 13](../week13_pytorch_basics/theory.md#4-building-models-with-nnmodule) (PyTorch)**              | `nn.Conv2d`, `nn.MaxPool2d` — same `nn.Module` API                                           |
| **[Week 14](../week14_training_at_scale/theory.md#2-the-data-pipeline) (Training at Scale)**    | Multi-worker DataLoader essential for image datasets; mixed precision for conv-heavy models  |
| **[Week 16](../week16_regularization_dl/theory.md#5-data-augmentation) (Regularisation DL)**    | Dropout after conv layers; data augmentation in `transforms`; weight decay                   |
| **[Week 17](../../06_sequence_models/week17_attention/theory.md#31-the-query-key-value-framework) (Attention)**            | Self-attention can be seen as a data-dependent convolution with a global receptive field     |
| **[Week 19](../../07_transfer_learning/week19_finetuning/theory.md#3-adaptation-strategies) (Fine-Tuning)**          | Feature extraction and fine-tuning patterns from this week formalised with adapters and LoRA |
...
| 2 (Training)            | Training loop         | MNIST training (5 epochs, Adam); test accuracy                   | [Week 13](../week13_pytorch_basics/theory.md#8-the-training-loop), Section 8 |
...
| $\gamma, \beta$                 | BatchNorm2d parameters          | Per-channel scale and shift ([Week 12](../../04_neural_networks/week12_training_pathologies/theory.md#7-fix-2-batch-normalisation))         |
